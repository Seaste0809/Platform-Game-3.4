...
class Bullet(Entity):
    def __init__(self, pos, *groups, bullet_x, bullet_y):
        ...
        self.pos = pygame.math.Vector2(self.bullet_x, self.bullet_y)
...
class PlatGrass(Entity):
    def __init__(self, pos, *groups):
        super().__init__(Color("#10eb93"), pos, *groups)
        self.image = pygame.transform.scale(pygame.image.load("Images/Background_images/grass.png"), (32, 32)).convert_alpha()

class PlatStone(Entity):
    def __init__(self, pos, *groups):
        super().__init__(Color("#10eb93"), pos, *groups)
        self.image = pygame.transform.scale(pygame.image.load("Images/Background_images/stone.jpg"), (32, 32)).convert_alpha()
